...
public class SwitchButton extends CompoundButton {
	 ...
	 * @param stateDrawable
	 *            状态图片
	 * @param stateMaskDrawable
	 *            状态遮罩图片
	 * @param sliderDrawable
	 *            滑块图片
	 */
	 ...
	 * 设置图片
	 * 
	 * @param frameDrawableResId
	 *            框架图片ID
	 * @param stateDrawableResId
	 *            状态图片ID
	 * @param stateMaskDrawableResId
	 *            状态遮罩图片ID
	 * @param sliderDrawableResId
	 *            滑块图片ID
	 */
	 ...
	 * 设置按钮和文本之间的间距
	 * 
	 * @param withTextInterval
	 *            按钮和文本之间的间距，当有文本的时候此参数才能派上用场
	 */
